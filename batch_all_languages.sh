...
LANG_CODES=(
    ...
    #"ZH" "ES" "CA" "EN" "HI" "AR" "PT" "BN" "RU" "JA" "PA" "DE" "FR" "VI" "MR" "TA" "UR" "TR" "IT" "FA" "PL" "UK" "RO" "NL" "TH" "HU" "EL" "HE" "ID" "MS" "KO" "SW" "FI" "CS" "DA" "SV" "SK" "BG" "HR" "SR" "SL" "LT" "LV" "ET" "EU" "GL" "GA" "CY" "MT" "IS" "MK" "HY" "BE" "SQ" "BS" "LB"
...
INPUT_FILE="test_data/input.csv"
